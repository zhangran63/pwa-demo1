...
self.addEventListener('install', function(e) {
 e.waitUntil( // service work 会等到waitUntil里面的代码执行完之后才可以安装
   caches.open('fox-store').then(function(cache) { // caches是一种特殊的cacheStorage对象，他能在service worker指定的范围内提供数据缓存。在此中，web storage失效
     return cache.addAll([
       '/pwa-demo1/a2hs/',
       '/pwa-demo1/a2hs/index.html',
       '/pwa-demo1/a2hs/index.js',
       '/pwa-demo1/a2hs/style.css',
       '/pwa-demo1/a2hs/images/fox1.jpg',
       '/pwa-demo1/a2hs/images/fox2.jpg',
       '/pwa-demo1/a2hs/images/fox3.jpg',
       '/pwa-demo1/a2hs/images/fox4.jpg'
     ]);
   })
 );
});
